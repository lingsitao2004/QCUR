%  time and error of QB_auto_QCUR using deim and mdeim methods
...
for k=20:20:200
    z=k/4;
    A=quaternion(randn(m,z)*randn(z,n),randn(m,z)*randn(z,n),randn(m,z)*randn(z,n),randn(m,z)*randn(z,n));
    Q = zeros(m, 0);
    B = zeros(0, n);
